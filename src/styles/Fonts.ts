import {Pacifico,Open_Sans,Roboto,Rubik_Marker_Hatch,Nunito, Dancing_Script} from "next/font/google"
...
export const rubikMarker  = Rubik_Marker_Hatch({weight:"400",subsets:['latin']})
export const dancing  = Dancing_Script({weight:"400",subsets:['latin']})
// export const pacifico  = Pacifico({weight:"400"})
// export const pacifico  = Pacifico({weight:"400"})