...
export default async function Home() {
  ...
  return (
    <main className="z-0 flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c] text-white">
      {/* drawer starts */}
  ...
  return (
    <div className="w-full max-w-xs">
      {posts.length ? posts.map((post,ind)=>(
        <div key={ind} className="w-full p-24 bg-stone-900">
