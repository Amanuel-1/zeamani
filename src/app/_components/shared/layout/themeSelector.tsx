...
const ThemeSelector = (props: themeSelectorProps) => {
  ...
  return (
    <div className="relative">
      <button
        className="  text-stone-700 dark:text-stone-500 p-2 rounded-full flex items-center"
      ...
      {isDropdownOpen && (
        <div className={`absolute z-50 ${props.footer?'-top-[6rem] right-10':'right-0' }  mt-2 bg-white  border  border-stone-200 dark:border-stone-800 rounded-md shadow-lg`}>
          <ul>
            <li
              className="block px-4 py-2 text-sm text-stone-500  cursor-pointer flex items-center"
