...
const ShareBar = ({content}:shareBarProps) => {
  return (
    <ul className="social-card  flex flex-row justify-center items-center w-full lg:max-w-fit lg:flex-col gap-5 px-4 py-8 lg rounded-r-[10px]text-stone-100 dark:text-stone-100  pointer-events-auto bg-black/10 rounded-md border border-gray-800/50">
